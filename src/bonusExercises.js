...
export const SYNONYM_WORDS = [
  // A2
  { word: 'happy',     level: 'B1', synonyms: ['glad', 'joyful', 'cheerful', 'pleased', 'delighted', 'content'] },
  { word: 'sad',       level: 'B1', synonyms: ['unhappy', 'upset', 'gloomy', 'down', 'miserable', 'sorrowful'] },
  { word: 'big',       level: 'B1', synonyms: ['large', 'huge', 'enormous', 'great', 'vast', 'massive'] },
  { word: 'small',     level: 'B1', synonyms: ['tiny', 'little', 'miniature', 'petite', 'slight', 'compact'] },
  { word: 'fast',      level: 'B1', synonyms: ['quick', 'rapid', 'swift', 'speedy', 'hasty', 'brisk'] },
  { word: 'good',      level: 'B1', synonyms: ['great', 'excellent', 'wonderful', 'fantastic', 'superb', 'fine'] },
  { word: 'bad',       level: 'B1', synonyms: ['terrible', 'awful', 'poor', 'dreadful', 'horrible', 'unpleasant'] },
  { word: 'nice',      level: 'B1', synonyms: ['lovely', 'pleasant', 'kind', 'friendly', 'wonderful', 'enjoyable'] },
  { word: 'funny',     level: 'B1', synonyms: ['amusing', 'hilarious', 'entertaining', 'comical', 'humorous', 'witty'] },
  { word: 'scared',    level: 'B1', synonyms: ['afraid', 'frightened', 'terrified', 'fearful', 'anxious', 'nervous'] },
  { word: 'hot',       level: 'B1', synonyms: ['warm', 'boiling', 'burning', 'scorching', 'blazing', 'heated'] },
  { word: 'cold',      level: 'B1', synonyms: ['cool', 'freezing', 'chilly', 'icy', 'frosty', 'bitter'] },
  { word: 'old',       level: 'B1', synonyms: ['aged', 'ancient', 'elderly', 'mature', 'senior', 'antique'] },
  { word: 'new',       level: 'B1', synonyms: ['fresh', 'modern', 'recent', 'latest', 'current', 'novel'] },
  { word: 'walk',      level: 'B1', synonyms: ['stroll', 'march', 'stride', 'wander', 'amble', 'trek'] },
  { word: 'talk',      level: 'B1', synonyms: ['speak', 'chat', 'converse', 'discuss', 'communicate', 'say'] },
  { word: 'look',      level: 'B1', synonyms: ['glance', 'stare', 'gaze', 'peek', 'observe', 'watch'] },
  { word: 'tired',     level: 'B1', synonyms: ['exhausted', 'weary', 'fatigued', 'sleepy', 'drained', 'worn out'] },
  { word: 'angry',     level: 'B1', synonyms: ['furious', 'mad', 'irritated', 'annoyed', 'enraged', 'cross'] },
