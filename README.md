...
- 📖 **Reading** — 15 texts across three levels (B1 / B2 / C1); completed texts don't repeat until all are read; progress bar per level with "Reset & repeat" option; tap any word to get its Slovak translation; per-question answer review
